...
contract BonusCrowdsale is Crowdsale, Ownable {
    ...
    */
    function buyTokens(address beneficiary) public payable {
        // Compute usd amount = wei * rate * tokenPriceInCents / centsPerUsd / (10 ** decimals)
        uint256 usdValue = msg.value.mul(rate).mul(tokenPriceInCents).div(100).div(10 ** tokenDecimals); 
