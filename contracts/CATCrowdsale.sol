...
import "./CAToken.sol";
import "./CATContinuousSale.sol";
import "./WhitelistedCrowdsale.sol";


contract CATCrowdsale is WhitelistedCrowdsale, CappedCrowdsale, FinalizableCrowdsale {

    uint256 public constant TOTAL_SHARE = 100;
    uint256 public constant CROWDSALE_SHARE = 50;
    uint256 public constant FOUNDATION_SHARE = 50;

    uint256 public constant CAP = 86206 ether;
    ...
    CATContinuousSale public continuousSale;
    ...
    function createContinuousSaleContract() internal returns(CATContinuousSale) {
        return new CATContinuousSale(rate, wallet, token);
    }
